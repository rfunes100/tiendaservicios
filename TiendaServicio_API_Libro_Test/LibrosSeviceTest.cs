...
namespace TiendaServicio_API_Libro_Test
{
   ...
   .Returns(dataPrueba.ElementType);
            ...
            dbSet.As<IQueryable<LibreriaMaterial>>()
                .Setup(x => x.Provider).
                Returns(new AsyncQueryProvider<LibreriaMaterial>
                (dataPrueba.Provider));
        ...
        [Fact]
        public async void GetLbroPorId()
        {
            ...
            var manejador = new ConsultaFiltro.Manejador
                (mockContexto.Object, mapper);
        ...
        public async void GetLibros()
        {
          //  System.Diagnostics.Debugger.Launch();
            ...
            var mapConfig = new MapperConfiguration(
                cfg => cfg.AddProfile(new MappingTest())
